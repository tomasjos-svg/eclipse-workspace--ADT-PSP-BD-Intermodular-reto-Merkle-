...
import com.ejemplo.centro.util.JPAUtilQueries;
...
public class AppJPA {
    ...
    private static final AdministrativoDAO ADMINISTRATIVO_DAO =
            new AdministrativoDAO();
    private static final CursoDAO CURSO_DAO = new CursoDAO();
    private static final AsignaturaDAO ASIGNATURA_DAO =
            new AsignaturaDAO();
    private static final DepartamentoDAO DEPARTAMENTO_DAO =
            new DepartamentoDAO();
    private static final ExpedienteDAO EXPEDIENTE_DAO =
            new ExpedienteDAO();
    public static void main(String[] args) {
        ...
        do {
            ...
            try {
                ...
                case 10 -> profesoresPorAsignatura();
                case 11 -> contarAlumnosPorCurso();
                case 12 -> actualizarEspecialidadProfesor();
                case 13 -> eliminarAlumnosDeCurso();
    ...
    private static void mostrarMenuPrincipal() {
        System.out.println();
        System.out.println("==========================================");
        System.out.println("       CENTRO - JAKARTA PERSISTENCE");
        System.out.println("==========================================");
        ...
        System.out.println("10. Mostrar profesores de una asignatura");
        System.out.println("11. Contar alumnos por curso");
        System.out.println("12. Actualizar especialidad de profesor");
        System.out.println("13. Eliminar alumnos de un curso");
    ...
    private static void crearAlumno() {
        ...
        Alumno alumno =
                new Alumno(dni, nombre, apellidos, codAlumno, curso);
    ...
    private static void actualizarExpediente() {
        ...
        expediente.setFechaApertura(fecha);
    ...
    private static void asignarAsignaturaAProfesor() {
        ...
        try {
            tx.begin();
            Profesor profesor =
                    em.find(Profesor.class, dni);
            Asignatura asignatura =
                    em.find(Asignatura.class, codigo);
            if (profesor == null) {
                System.out.println("El profesor no existe.");
                tx.rollback();
                return;
    ...
    private static void alumnosPorCurso() {
        int codigo = leerEntero("Código del curso: ");
        var alumnos = JPAUtilQueries.alumnosPorCurso(codigo);
        if (alumnos.isEmpty()) {
    ...
    private static void profesoresPorAsignatura() {
        ...
        var profesores = JPAUtilQueries.profesoresPorAsignatura(codigo);
    ...
    private static void contarAlumnosPorCurso() {
        var resultados = JPAUtilQueries.contarAlumnosPorCurso();
        System.out.println();
    ...
    private static void actualizarEspecialidadProfesor() {
        System.out.print("DNI del profesor: ");
        String dni = SC.nextLine();
        System.out.print("Nueva especialidad: ");
        String especialidad = SC.nextLine();
        int modificados =JPAUtilQueries.actualizarEspecialidad(dni,especialidad);
        if (modificados == 0) {
    ...
    private static void eliminarAlumnosDeCurso() {
        int codigo = leerEntero("Código del curso: ");
        System.out.println();
        System.out.println("ATENCIÓN: se eliminarán los alumnos del curso " + codigo);
        ...
        int eliminados =JPAUtilQueries.eliminarAlumnosDeCurso(codigo);
        System.out.println("Alumnos eliminados: " + eliminados );
    }
    // =========================================================
    // MÉTODOS AUXILIARES
    // =========================================================
